package net.bored_moon.examplemod.fluid;
...
public class ModFluids {
    ...
    public static final RegistryObject<FlowingFluid> FLOWING_FLUID_WATER = FLUIDS.register("flowing_soap_fluid",
    ...
    public static final ForgeFlowingFluid.Properties SOAP_WATER_FLUID_PROPERTIES = new ForgeFlowingFluid.Properties(
            ModFluidTypes.SOAP_WATER_FLUID_TYPE, SOURCE_SOAP_WATER, FLOWING_FLUID_WATER)
            .slopeFindDistance(2).levelDecreasePerBlock(3).block(ModBlocks.SOAP_WATER_BLOCK).bucket(ModItems.SOAP_WATER_BUCKET);
